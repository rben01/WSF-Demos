...
NotebookDataLength[     23255,        502]
NotebookOptionsPosition[     23558,        494]
NotebookOutlinePosition[     24021,        514]
CellTagsIndexPosition[     23978,        511]
WindowFrame->Normal*)
   ...
   TagBox[
    StyleBox[
     DynamicModuleBox[{$CellContext`enn$$ = 1, $CellContext`m$$ = 
      ...
      False, $CellContext`V$2917$$ = 0, $CellContext`m$2918$$ = 
      0, $CellContext`enn$2919$$ = 0}, 
      DynamicBox[Manipulate`ManipulateBoxes[
       1, StandardForm, 
        "Variables" :> {$CellContext`enn$$ = 1, $CellContext`m$$ = 
          0.1, $CellContext`V$$ = 5}, "ControllerVariables" :> {
          Hold[$CellContext`V$$, $CellContext`V$2917$$, 0], 
          Hold[$CellContext`m$$, $CellContext`m$2918$$, 0], 
          Hold[$CellContext`enn$$, $CellContext`enn$2919$$, 0]}, 
        "OtherVariables" :> {
...
(*NotebookFileOutline
Notebook[{
Cell[1235, 30, 22319, 462, 577, InheritFromParent]
}
]
*)
...
(* NotebookSignature NvDuhtEJr12tnAwfG9DgBuJn *)
