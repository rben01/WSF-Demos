...
:nofooter:
:stem: latexmath
:table-settings: pass:[cols="<1s,<4a,<4a",options="header"]
:imagesdir: images
:data-uri:
...
|PROBLEM different wavefunction
...
| Calculate stem:[ \big\langle-\frac{\partial V}{\partial x} \big\rangle] for the following wavefunction:
...
What quantity is this equal to? 
...
| PROBLEM use a different wavefunction
