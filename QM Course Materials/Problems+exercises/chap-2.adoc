...
* *2.1.{counter:qn}* [Similar to Griffiths text (not a problem). Need to modify more]
...
* *2.3.{counter:qn}* [Thaller] Show that any solution ++\(\Psi\)++ of the harmonic oscillator satisfies ++\(\Psi(x,t+\pi)=e^{-i\pi/2}\Psi(-x,t)\)++. (Corollary: ++\(\Psi(x,t+2\pi)=-\Psi(-x,t)\)++.)
