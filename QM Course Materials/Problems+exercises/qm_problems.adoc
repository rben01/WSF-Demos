...
. Use Pascal's triangle to determine the probability of landing at each integer after 7 steps. What is the probability of landing at x=5? Where are you most likely to land? Calculate the expected value. What is the standard deviation?
